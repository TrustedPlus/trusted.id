...
//Login
define("TR_ID_OPT_CLIENT_ID", COption::GetOptionString(TR_ID_MODULE_ID, "CLIENT_ID", ""));
define("TR_ID_OPT_CLIENT_SECRET", COption::GetOptionString(TR_ID_MODULE_ID, "CLIENT_SECRET", ""));

//Database

define("TR_ID_DB", true);
if (COption::GetOptionString(TR_ID_MODULE_ID, "SERVICE_HOST", "") === "net.trusted.ru") {
    define("TR_ID_DB_TABLE_USER", "trn_user_ntr");
} else {
    define("TR_ID_DB_TABLE_USER", "trn_user_itp");
}

//Trusted URI
define('TR_ID_OPT_SERVICE_HOST', COption::GetOptionString(TR_ID_MODULE_ID, "SERVICE_HOST", ""));
define('TR_ID_COMMAND_URI_HOST', 'https://' . TR_ID_OPT_SERVICE_HOST);
...
define("TR_ID_WIDGET_REDIRECT_URI", TR_ID_URI_MODULE_AUTH . "/wauth.php");
