...
DEFINE("TN_AUTH_MODULE_ID", "trustednet.auth");

DEFINE("TN_USE_SEND_MAIL_SETTINGS", false);
DEFINE("TN_DEFAULT_SHOULD_SEND_MAIL", false);
DEFINE("TN_DEBUG", false);
define("LOG_FILENAME", $_SERVER["DOCUMENT_ROOT"] . "/trustednet_auth-log.txt");

define("TRUSTED_DEBUG", false);

define("TRUSTED_SSL_VERSION", 0);

define('TRUSTED_COMPONENT_PATH', '/bitrix/components/trustednet');

define('TRUSTED_PROJECT_ROOT', $_SERVER['DOCUMENT_ROOT']);
define('TRUSTED_MODULE_ROOT', TRUSTED_PROJECT_ROOT . TRUSTED_COMPONENT_PATH);
define('TRUSTED_MODULE_PATH', TRUSTED_PROJECT_ROOT . '/bitrix/modules/trustednet.auth');
...
define('TRUSTED_URI_MODULE', TRUSTED_URI_HOST . TRUSTED_COMPONENT_PATH);
